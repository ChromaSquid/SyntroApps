...
void StreamsDlg::onOk()
{
    ...
    if (m_highRateMinInterval->text() != settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_MININTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_HIGHRATE_VIDEO_MININTERVAL, m_highRateMinInterval->text());
		changed = true;
	}

    if (m_highRateMaxInterval->text() != settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_MAXINTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_HIGHRATE_VIDEO_MAXINTERVAL, m_highRateMaxInterval->text());
		changed = true;
	}

    if (m_highRateNullInterval->text() != settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_NULLINTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_HIGHRATE_VIDEO_NULLINTERVAL, m_highRateNullInterval->text());
		changed = true;
	}

    if (m_lowRateMinInterval->text() != settings->value(SYNTROPANACAM_LOWRATE_VIDEO_MININTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_LOWRATE_VIDEO_MININTERVAL, m_lowRateMinInterval->text());
		changed = true;
	}

    if (m_lowRateMaxInterval->text() != settings->value(SYNTROPANACAM_LOWRATE_VIDEO_MAXINTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_LOWRATE_VIDEO_MAXINTERVAL, m_lowRateMaxInterval->text());
		changed = true;
	}

    if (m_lowRateNullInterval->text() != settings->value(SYNTROPANACAM_LOWRATE_VIDEO_NULLINTERVAL).toString()) {
        settings->setValue(SYNTROPANACAM_LOWRATE_VIDEO_NULLINTERVAL, m_lowRateNullInterval->text());
		changed = true;
	}
...
void StreamsDlg::layoutWindow()
{
    ...
    m_highRateMinInterval->setText(settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_MININTERVAL).toString());
    ...
    m_highRateMaxInterval->setText(settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_MAXINTERVAL).toString());
    ...
    m_highRateNullInterval->setText(settings->value(SYNTROPANACAM_HIGHRATE_VIDEO_NULLINTERVAL).toString());
    ...
    m_lowRateMinInterval->setText(settings->value(SYNTROPANACAM_LOWRATE_VIDEO_MININTERVAL).toString());
    ...
    m_lowRateMaxInterval->setText(settings->value(SYNTROPANACAM_LOWRATE_VIDEO_MAXINTERVAL).toString());
    ...
    m_lowRateNullInterval->setText(settings->value(SYNTROPANACAM_LOWRATE_VIDEO_NULLINTERVAL).toString());
