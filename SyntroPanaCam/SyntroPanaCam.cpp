...
void SyntroPanaCam::clientRunning()
{
	...
	connect(m_camera, SIGNAL(netcamStatus(QString)), this, SLOT(netcamStatus(QString)), Qt::DirectConnection);
...
void SyntroPanaCam::onAbout()
{
	SyntroAbout *dlg = new SyntroAbout();
	dlg->show();
}

void SyntroPanaCam::onBasicSetup()
{
	BasicSetupDlg *dlg = new BasicSetupDlg(this);
	dlg->show();
}

void SyntroPanaCam::onConfigureStreams()
{
	StreamsDlg *dlg = new StreamsDlg(this);
	connect(dlg, SIGNAL(newStream()), m_cameraClient, SLOT(newStream()), Qt::QueuedConnection);
	dlg->show();
}

void SyntroPanaCam::onConfigureCamera()
{
...
void SyntroPanaCam::onConfigureMotion()
{
...
void SyntroPanaCam::saveWindowState()
{
...
void SyntroPanaCam::restoreWindowState()
{
	QSettings *settings = SyntroUtils::getSettings();
...
void SyntroPanaCam::closeEvent(QCloseEvent *)
{
	saveWindowState();
...
void SyntroPanaCam::newImage(QImage frame)
{
	m_frameCount++;
...
void SyntroPanaCam::timerEvent(QTimerEvent *event)
{
...
void SyntroPanaCam::showImage(const QImage &frame)
{	
	if (isMinimized()) 
		return;
...
void SyntroPanaCam::netcamStatus(QString status)
{
